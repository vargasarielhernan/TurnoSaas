...
namespace TurnosSaas.Controllers
{
    public class ProductoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ProductoId,Codigo,Nombre,Descripcion,Precio,Imagen,CategoriaId,Stock,Activo")] Producto producto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProductoId,Codigo,Nombre,Descripcion,Precio,Imagen,CategoriaId,Stock,Activo")] Producto producto)
        {
